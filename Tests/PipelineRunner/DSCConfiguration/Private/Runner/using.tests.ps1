...
Describe "using Function Tests" -Tag Unit, PipelineRunner, Runner {
    ...
    # outer expression - e.g. $((using 'X').Property) in a property value - never as a bare
    # statement, which is what a direct call here would otherwise be.
