...
Everything human-readable goes to the **information** stream tagged `DSC.PipelineRunner.Akkodis`, not
...
$log | Where-Object { $_.Tags -contains 'DSC.PipelineRunner.Akkodis' }
```
