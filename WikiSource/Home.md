...
`DSC.PipelineRunner.Akkodis` applies Desired State Configuration from a CI/CD pipeline. It compiles a
...
| Merge partial resources, or expand a composite | [Composite and Stub Resources](Composite-and-Stub-Resources) |
| Apply changes only in a maintenance window, or override one resource's mode | [Scheduled Enforcement and Execution Overrides](Scheduled-Enforcement) |
...
Conceptual pages are authored in [`WikiSource/`](https://github.com/Akkodis-Solution-Engineering/AzDO-DSC-LCM/tree/main/WikiSource).
