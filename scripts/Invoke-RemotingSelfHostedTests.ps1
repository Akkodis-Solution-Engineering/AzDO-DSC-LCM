...
belongs on the self-hosted runner. This is what the WinRM/DSCv2/DSCv3 self-hosted workflow job
...
$config.Run.Path         = Join-Path $RepositoryRoot 'Tests/PipelineRunner/Intergration/Tests/WinRMTarget.Integration.tests.ps1'
