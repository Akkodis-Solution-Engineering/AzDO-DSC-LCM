...
The resolved HEAD SHA is written to the information stream (tag 'DSC.PipelineRunner.Akkodis') so
...
function Clone-Repository
{
    ...
    Write-Information -MessageData "[Clone-Repository] Cloned '$DatumURLConfig' at commit '$headSha' into '$DestinationPath'." -Tags 'DSC.PipelineRunner.Akkodis'
